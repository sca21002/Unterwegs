use utf8;
package Unterwegs::Schema::Result::GeographyColumn;
...
Unterwegs::Schema::Result::GeographyColumn
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:MD/CyIndz2BRSqLl571iCQ
